	...
	<main class="flex-col project-page">
		...
		<div class="navigation">
			<NuxtLink
				...
				:to="{ name: 'project-projectName', params: { projectName: prev.name } }"
			>
				<ArrowIcon />
				{{ $t('projectPrev') }}
			</NuxtLink>
			...
			<NuxtLink
				...
				:to="{ name: 'project-projectName', params: { projectName: next.name } }"
			>
				{{ $t('projectNext') }}
				<ArrowIcon />
			</NuxtLink>
			...
			<div class="cards">
				<div v-for="(p, i) in others" :key="i" class="card card-back br1 rel">
					<NuxtLink
						...
						:to="{ name: 'project-projectName', params: { projectName: p.name } }"
					>
						<FrameLoader
							:iframe-class="{
								white_bg: p.white_bg,
